...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // Template manager specific methods
  fetchTemplateForGeneration: (userId, studyType) => ipcRenderer.invoke('fetch-template-for-generation', userId, studyType),
  fetchAgentLogicV2: (userId, studyType) => ipcRenderer.invoke('fetch-agent-logic-v2', userId, studyType),
  saveAgentLogic: (data) => ipcRenderer.invoke('save-agent-logic', data),
...
// Also expose under electron namespace for compatibility
