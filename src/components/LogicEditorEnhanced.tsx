      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ marginTop: 16, display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <div style={{ flex: 1 }} />
            <button
              onClick={userTier >= 5 ? () => setShowPromptPreview(true) : undefined}
              disabled={userTier < 5}
              title={userTier < 5 ? 'Requires Developer tier (Tier 5)' : 'Preview AI Prompt'}
              style={{
                padding: '8px 16px',
                backgroundColor: userTier < 5 ? '#666' : '#8e44ad',
                color: userTier < 5 ? '#999' : '#fff',
                border: 'none',
                borderRadius: 6,
